...
def printRegister(p4info_helper, sw, register_name, index):
    ...
    :param index: the counter index (in our case, the tunnel ID)
    """
    for response in sw.ReadRegister(369133629, index):
        for entity in response.entities:
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        while True:
            ...
            printRegister(p4info_helper, s2, "MyIngress.utilization_reg", 0)
            printRegister(p4info_helper, s2, "MyIngress.utilization_reg", 1)
            printRegister(p4info_helper, s2, "MyIngress.utilization_reg", 2)
            printRegister(p4info_helper, s2, "MyIngress.utilization_reg", 3)
